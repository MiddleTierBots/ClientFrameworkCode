...
namespace SCC.Math
{
    ...
    public static class RandomExtension
    {
        ...
        public static decimal NextDecimal(this System.Random rand)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
        ...
        public static decimal NextDecimal(this System.Random rand, decimal minValue, decimal maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
            if (minValue > maxValue)
        ...
        public static byte NextByte(this System.Random rand)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
        ...
        public static byte NextByte(this System.Random rand, byte maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
        ...
        public static byte NextByte(this System.Random rand, byte minValue, byte maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
            if (minValue > maxValue)
        ...
        public static sbyte NextSByte(this System.Random rand)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
        ...
        public static sbyte NextSByte(this System.Random rand, sbyte maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
            if (maxValue < 0)
        ...
        public static sbyte NextSByte(this System.Random rand, sbyte minValue, sbyte maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
            if (minValue > maxValue)
        ...
        public static short NextShort(this System.Random rand)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
        ...
        public static short NextShort(this System.Random rand, short maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
            if (maxValue < 0)
        ...
        public static short NextShort(this System.Random rand, short minValue, short maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
            if (minValue > maxValue)
        ...
        public static ushort NextUShort(this System.Random rand)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
        ...
        public static ushort NextUShort(this System.Random rand, ushort maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
        ...
        public static ushort NextUShort(this System.Random rand, ushort minValue, ushort maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
            if (minValue > maxValue)
        ...
        public static uint NextUInt(this System.Random rand)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
        ...
        public static uint NextUInt(this System.Random rand, uint maxValue)
        {
        ...
        public static uint NextUInt(this System.Random rand, uint minValue, uint maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
            if (minValue > maxValue)
        ...
        public static long NextLong(this System.Random rand)
        {
        ...
        public static long NextLong(this System.Random rand, long maxValue)
        {
            if (maxValue < 0)
                throw new ArgumentOutOfRangeException(nameof(maxValue), maxValue, $"'{nameof(maxValue)}' must be greater than 0.");
        ...
        public static long NextLong(this System.Random rand, long minValue, long maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
            if (minValue > maxValue)
        ...
        public static ulong NextULong(this System.Random rand)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
        ...
        public static ulong NextULong(this System.Random rand, ulong maxValue)
        {
        ...
        public static ulong NextULong(this System.Random rand, ulong minValue, ulong maxValue)
        {
            if (rand is null)
                throw new ArgumentNullException(nameof(rand));
            if (minValue > maxValue)
